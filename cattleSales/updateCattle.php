	...
	$id = $_GET['id'];
		...
		if($cattleType == "")	echo "<p class='errorMessage'>Please select a cattle type</p>";
			...
			else
			{
				...
				$sql = "UPDATE seller SET cattleType='$cattleType',breed='$breed',country='$country',weight=$weight,image='$image',state='$state',address='$address',contact='$contactNo',price=$price,cattleDesc='$cattleDesc' WHERE id='$id' ";
				...
				if(mysqli_query($conn,$sql)){
					echo "<script>
							...
							document.location = 'home.php';
								...
								echo '<p class="errorMessage">OOPS. Something went wrong. Try again</p>'.mysqli_error($conn) ;
							}
...
<!-- $sql = "UPDATE seller SET cattleType='$cattleType',country='$country',weight=$weight,state='$state',address='$address',contact='$contactNo',price=$price WHERE id=$id  "; -->
