...
<body>
	<h1 align="center">Can You adopt my pet?</h1>
	<hr>
				...
				if(mysqli_num_rows($result)==0)
					{
						echo 'Invalid user name. <a href="signup.php"> Signup </a> if new user';
							...
							$sql = "INSERT INTO pets VALUES('?','$userName','$petType','$story','$image','$contactNo','$country','$state','$address',NOW(),'n','','') ";
							if(mysqli_query($conn,$sql)){
								echo "<script>
										alert('Soon your pet would be adopted');
